  ...
  grunt.initConfig({
    ...
    usemin: {
      ...
      options: {
        ...
        patterns: {
          js: [
            [/(images\/\w+\.(png|jpg|jpeg|gif|webp|svg))/gm, 'Searching for /images/ pattern'],
            [/(hola\.png)/gm, 'Searching for /images/ pattern']
          ],
          html: [
            [/(images\/\w+\.(png|jpg|jpeg|gif|webp|svg))/, 'Searching for /images/ pattern']
          ],
        }
      }
    },
